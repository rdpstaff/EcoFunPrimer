...
/**
 *
 * @author xingziye, tift, gunturus
 */
public final class HenikoffWeighting implements Weighting {
    
    private final List<Sequence> seqs;
    private final Map<String, Double> weightMap = new HashMap();
    
    public HenikoffWeighting(List<Sequence> s){
        this.seqs = s;
        this.calcWeights();
    }
